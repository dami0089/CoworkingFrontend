...
const ModalNuevoAdicional = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await adicionales({
      cliente: editarCliente._id,
      nombre: editarCliente.nombre,
      detalle: descripcionAd,
      importe: importeAd,
      notas: notasAd,
    });
    setTimeout(() => {
  ...
  return (
    <Transition.Root show={modalAdicional} as={Fragment}>
      <Dialog
        as="div"
        className="fixed inset-0 z-10 overflow-y-auto"
        onClose={handleModalAdicional}
      >
...
export default ModalNuevoAdicional;
