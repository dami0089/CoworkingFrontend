          ...
          <div className="flex">
            ...
            <div className="flex flex-1 flex-col items-center justify-between border-r p-4">
              ...
              <button
                ...
                className="mt-3 rounded bg-blue-500 px-3 py-1 font-bold text-white hover:bg-blue-700"
              >
                Scan DNI
              </button>
            </div>
            ...
            <div className="flex flex-1 flex-col justify-between p-4">
              <div>
                ...
                <div className="mb-2">
                  ...
                  <input
                    ...
                    className="focus:shadow-outline w-full appearance-none rounded border px-2 py-1 uppercase text-gray-700 shadow focus:outline-none"
                  />
                </div>
                <div className="flex space-x-4">
                  <div className="mb-2 w-1/3">
                    ...
                    <input
                      ...
                      className="focus:shadow-outline w-full appearance-none rounded border px-2 py-1 text-gray-700 shadow focus:outline-none"
                    />
                  </div>
                  <div className="mb-2 w-1/3">
                    <label className="mb-1 block text-sm font-bold text-gray-700">
              ...
              <div className="flex flex-col items-center">
                <button
                  ...
                  className=" mt-5 rounded bg-blue-500 px-3 py-1 font-bold text-white hover:bg-blue-700"
                >
                  Registrar Visitante
                </button>
              </div>
